"""Result of an ARM API call with nextLink paging."""
...
class ArmResult:
    """Wraps an ARM ``requests.Response`` and can follow ``nextLink``."""
    ...
    def values(self) -> List[Any]:
        """Return all ``value`` items, following ARM ``nextLink`` until exhausted."""
